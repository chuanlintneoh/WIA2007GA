...
//
//    private QRDisplayViewModel mViewModel;
//
//    public static QRDisplay newInstance() {
...
//
//        // Get the QR image view
//        ImageView qrImageView = view.findViewById(R.id.qr);
//
//        // Load and display the QR image here
//        qrImageView.setImageResource(R.drawable.img_qr); // Replace with your QR image resource
//
//        return view;
//    }
//
...
//        mViewModel = new ViewModelProvider(this).get(QRDisplayViewModel.class);
