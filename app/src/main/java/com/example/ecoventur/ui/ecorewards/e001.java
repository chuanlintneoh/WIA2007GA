...
public class e001 extends Fragment {
    private E003ViewModel viewModelE003;
    private E001ViewModel viewModelE001;

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        viewModelE003 = new ViewModelProvider(requireActivity()).get(E003ViewModel.class);
        viewModelE001 = new ViewModelProvider(requireActivity()).get(E001ViewModel.class);
    }

    public static e001 newInstance() {
        return new e001();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_e001, container, false);
    }
